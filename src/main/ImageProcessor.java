...
//    System.err.println("Beginning alignment computation with map size " + large.getWidth() + "," + large.getHeight());
    ...
    int yLimit = large.getHeight() - small.getHeight() + OFFSET_LIMIT;
    int xLimit = large.getWidth() - small.getWidth() + OFFSET_LIMIT;
...
//      e.printStackTrace();
  ...
  public static BufferedImage findBestAlignmentOld(BufferedImage small, BufferedImage large) {
//    System.err.println("Beginning alignment computation with map size " + large.getWidth() + "," + large.getHeight());
    int bestAlign = Integer.MAX_VALUE;
    int bestSkipped = 0;
    Point maxPos = null;
...
//      e.printStackTrace();
  ...
  public static final Rectangle MAP_RECT_CROPPED = new Rectangle(831, 70, 92, 92);
  public static final Rectangle MAP_RECT_SMALL = new Rectangle(MAP_RECT_CROPPED.x - MAP_CROP, MAP_RECT_CROPPED.y - MAP_CROP, MAP_RECT_CROPPED.width + MAP_CROP * 2,
      MAP_RECT_CROPPED.height + MAP_CROP * 2);
